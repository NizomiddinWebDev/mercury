...
<body class="bg-white">
    ...
    <div class="flex-row max-w-7xl mx-auto items-center justify-between mt-20 mb-60">
        ...
        <div class="flex">
            <div>
                <div class="text-2xl text-blue-700 font-bold text-center decoration-blue-200 relative top-14 left-10">
                    124 платформы</div>
                <div class="text-center font-semibold text-sm relative top-20 left-10">
                    ...
                    <img src="{{ asset('/images/vektor-1.png') }}" alt="vector rasmi"
                        class="w-40 relative top-7 left-32">
                </div>
            </div>
            <div>
                ...
                <div class="text-center font-semibold text-sm relative top-48 left-24">
                    ...
                    <img src="{{ asset('/images/vektor-2.png') }}" alt="vector rasmi"
                        class=" w-40 relative bottom-48 left-32 ">
                </div>
            </div>
            <div>
                ...
                <div class="text-center font-semibold text-sm relative top-20 left-44">
                    ...
                    <img src="{{ asset('/images/vektor-3.png') }}" alt="vector rasmi"
                        class=" w-40 relative top-5 left-28">
                </div>
            </div>
            <div>
        ...
        <div class="max-w-3xl mx-auto">
            <div class="flex">
                <div class="w-1/2">
                    ...
                    <div class="text-gray-500">Расскажите о вашем продукте, предоставьте логотипы, баннеры, тексты и
                        то,
